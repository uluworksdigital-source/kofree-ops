...
class OrderPushNotificationBuilder
{
    ...
    private function message($fcmTokenArray, $status, $orderId): void
    {
        if ($status == OrderStatus::PENDING) {
            ...
            $this->preparing($fcmTokenArray, $orderId);
        } elseif ($status == OrderStatus::PREPARED) {
            $this->prepared($fcmTokenArray, $orderId);
    ...
    private function preparing($fcmTokenArray, $orderId): void
    {
    ...
    private function prepared($fcmTokenArray, $orderId): void
    {
