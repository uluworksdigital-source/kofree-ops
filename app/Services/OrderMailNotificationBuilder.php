...
class OrderMailNotificationBuilder
{
    ...
    private function message($name, $email, $status, $orderId)
    {
        if ($status == OrderStatus::PENDING) {
            ...
            $this->preparing($name, $email, $orderId);
        } elseif ($status == OrderStatus::PREPARED) {
            $this->prepared($name, $email, $orderId);
    ...
    private function preparing($name, $email, $orderId)
    {
    ...
    private function prepared($name, $email, $orderId)
    {
