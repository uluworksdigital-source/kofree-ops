    ...
    <div class="col-12">
        <div class="grid grid-cols-1 sm:grid-cols-3 mb-4 sm:mb-0">
            <button type="button" @click="handleTab($event, '#information', '.db-tabBtn', '.db-tabDiv', 'active')"
                class="db-tabBtn active !justify-start"><i class="lab lab-information lab-font-size-16"></i>{{
                    $t('label.information') }}
            </button>
            ...
            <button type="button" @click="handleTab($event, '#item', '.db-tabBtn', '.db-tabDiv', 'active')"
                class="db-tabBtn !justify-start"><i class="lab lab-bag-2 lab-font-size-16"></i>
                {{ $t('label.items') }}
            </button>
        </div>
