<template>
    ...
    <div
        ...
        <img v-if="parseInt(props.status) === parseInt(enums.orderStatusEnum.DELIVERED)" class="h-32 mx-auto mb-3"
            :src="setting.image_order_delivered" alt="gif">
        ...
        <h5 v-if="parseInt(props.status) === parseInt(enums.orderStatusEnum.ACCEPT)"
            class="text-xs font-normal text-center mb-8">
            {{ $t("message.Your_order_is_accepted") }}
        </h5>
        <h5 v-if="parseInt(props.status) === parseInt(enums.orderStatusEnum.PREPARING)"
            class="text-xs font-normal text-center mb-8">
            {{ $t("message.the_chef_is_preparing_your_food") }}
        </h5>
        ...
        <h5 v-if="parseInt(props.status) === parseInt(enums.orderStatusEnum.OUT_FOR_DELIVERY)"
            class="text-xs font-normal text-center mb-8">
            {{ $t("message.delivery_man_is_on_the_way") }}
        </h5>
