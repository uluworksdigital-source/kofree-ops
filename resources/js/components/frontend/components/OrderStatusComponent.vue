        ...
        <ul
            ...
            <li v-if="parseInt(props.order_type) == parseInt(enums.orderTypeEnum.DELIVERY)"
                ...
                <span
                    ...
                    {{ parseInt(index) === parseInt(enums.orderStatusEnum.OUT_FOR_DELIVERY)
                        ? delivery
                        : $t('menu.order') + ' ' + delivery }}
                </span>
            </li>
            <li v-if="parseInt(props.order_type) == parseInt(enums.orderTypeEnum.TAKEAWAY) || parseInt(props.order_type) == parseInt(enums.orderTypeEnum.DINING_TABLE)"
